      ...
      <section className="componentContainer">
        <div className="coin_desc">
          ...
          <p className="coin_desc-para">
            ...
            know what each piece is and how they work, you are ready to do some
            test transactions to get you familiar with the process. You have
            recieved test balance generated by the Cryptorial, and this will
            allow you to purchase fake bitcoins, which you will then sell back
            to the Cryptorial, so you can see the procedure in action.
          </p>
          <p className="coin_desc-para">
